...
def build_it_issue_card(language: str,
    ...
    card_content: Dict[str, Any] = {
        ...
        "body": [
            ...
            {"type": "TextBlock", "text": t["upload_options"], "wrap": True, "weight": "Bolder", "spacing": "Medium"},
            {"type": "ActionSet", "actions": [
                {"type": "Action.Submit", "title": t["opt1"], "data": {"action": "uploadOption", "opt": "1"}},
                {"type": "Action.Submit", "title": t["opt2"], "data": {"action": "uploadOption", "opt": "2"}},
                {"type": "Action.Submit", "title": t["opt3"], "data": {"action": "uploadOption", "opt": "3"}}
            ]},
